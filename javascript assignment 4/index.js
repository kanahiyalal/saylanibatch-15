...
// Online Course Enrollment Processor
// Scenario:An online platform tracks course enrollments for students. Each enrollment includes the
// student's name, selected course, and enrollment date.
// Task:Write a function that processes an array of enrollment objects, each containing:
...
// const onlineCourse = [
//     {name: "Alice" , course: "Web Development" , enrollmentDate : "2025-5-15"},
//     {name: "smith" , course: "Data Science" , enrollmentDate : "2025-4-23"},
//     {name: "bob" , course: "Graphic Design" , enrollmentDate : "2025-3-5"}
// ]
// function calculateTotalFees(course){
//     let discount = 0.10
//     let total = 0
//     for(let i = 0; i<course.length; i++){
//         switch (course[i].course.tolowerCase()) {
...
//                 break;    
//             default:
//                 console.log(`courses not found: ${course[i].course}`);
//         }
//     }
//     return discount ? total * (1 - discount) : total
// }
// console.log("Total  fees:", + calculateTotalFees(onlineCourse));